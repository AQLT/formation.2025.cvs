...
Quel type de point atypique est le plus adapté ?
...
E. Un autre type  (pure seasonal outlier, ramp, etc.) 
:::
...
__E. Un autre type (**pure seasonal outlier**, **ramp**, etc.)__
:::
...
**D. Les tests de saisonnalité résiduelle**
:::
...
B. Partial-concurrent all outliers
