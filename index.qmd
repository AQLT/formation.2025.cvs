...
2. **Correction des jours ouvrables** : [V2](TP/R_2_CJO_v2.qmd) ou [V3](TP/R_2_CJO_v3.qmd) et programme [export_cjo.R](ex-cjo/export_cjo.R)
...
5. **JDemetra+ en production** : [V2](TP/R_5_JD_in_production_v2.qmd) ou [V3](TP/R_5_JD_in_production_v3.qmd) et programmes [1-cruncher.R](R-macronia/1-cruncher.R) et [2-tableau de bord.R](R-macronia/2-tableau_de_bord.R)
