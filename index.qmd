...
5. **JDemetra+ en production** : [V2](TP/R_5_JD_in_production_v2.qmd) ou [V3](TP/R_5_JD_in_production_v3.qmd) et programmes [1-cruncher.R](R-macronia/1-cruncher.R) et [2-tableau de bord.R](R-macronia/3-tableau_de_bord.R)

6. **Autres programmes** : [3-imae-calage.R](R-macronia/4-imae_calage.R) et [4-cvs-indirecte.R](R-macronia/5-cvs_indirecte.R)
